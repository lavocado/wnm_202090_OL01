	...
	<main>
		...
		<div class="container">
			...
			<div id="trending" class="container display-flex display-stretch flex-justify-center">
				<a href="shop.php"><img class="carousel" src="img/1.png"></a>
				<div class="flex-stretch"></div>
				<a href="shop.php"><img class="carousel" src="img/5.png"></a>
				<div class="flex-stretch"></div>
				<a href="shop.php"><img class="carousel" src="img/2.png"></a>
				<div class="flex-stretch"></div>
				<a href="shop.php"><img class="carousel" src="img/3.png"></a>
			</div>
